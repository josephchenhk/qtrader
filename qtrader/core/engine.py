...
from qtrader.core.event import Event, EventEngine
from qtrader.core.app import BaseApp
...
class MainEngine:
    ...
    def __init__(self, event_engine: EventEngine = None):
        ...
        self.event_engine.start()  # 已经开始event loop（启动 _run 和 _run_timer）
        ...
        try:                 # Change working directory
            os.chdir(TRADER_DIR)
        except TypeError:    # CHG(joseph): compatible with py3.5 or lower
    ...
    def init_engines(self) -> None:
        """
        Init all engines. (将所有engine实例化，并且存放在一个字典self.engines中)
        """
...
class LogEngine(BaseEngine):
    ...
    def __init__(self, main_engine: MainEngine, event_engine: EventEngine):
        ...
        self.level = SETTINGS["log.level"] # : int

        self.logger = logging.getLogger("VN Trader") # : Logger
    ...
    def add_file_handler(self) -> None:
        ...
        file_handler = logging.FileHandler(
            str(file_path), mode="a", encoding="utf8"
        )
...
class EmailEngine(BaseEngine):
    ...
    def __init__(self, main_engine: MainEngine, event_engine: EventEngine):
        ...
        self.thread = Thread(target=self.run) # : Thread
        self.thread.setName("EmailEngineThread")
