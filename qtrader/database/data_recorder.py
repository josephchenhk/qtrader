# -*- coding: utf-8 -*-
# @Time    : 17/2/2021 12:12 PM
# @Author  : Joseph Chen
# @Email   : josephchenhk@gmail.com
# @FileName: data_recorder.py
# @Software: PyCharm
...
from qtrader.core.engine import BaseEngine, MainEngine
...
from qtrader.core.event import EVENT_TICK, EVENT_CONTRACT
from qtrader.core.utility import load_json, save_json, BarGenerator
...
class RecorderEngine(BaseEngine):
    ...
    def __init__(self, main_engine: MainEngine, event_engine: EventEngine):
        ...
        self.queue = Queue()
        self.thread = Thread(target=self.run, name="recorder_run")
        self.active = False
