...
class BaseGateway(ABC):
    ...
    * on_contract
    ...
    def __init__(self, event_engine: EventEngine, gateway_name: str):
        ...
        self.gateway_name = gateway_name   # : str
    ...
    def write_log(self, msg: str) -> None:
        ...
        """
        log = LogData(msg=msg, gateway_name=self.gateway_name, level=INFO)
        self.on_log(log)
...
class LocalOrderManager:
    ...
    def __init__(self, gateway: BaseGateway, order_prefix: str = ""):
        """"""
        self.gateway = gateway # : BaseGateway

        # For generating local orderid
        self.order_prefix = order_prefix  # : str
        ...
        self.push_data_callback = None # : Callable

        # Cancel request buf
        self.cancel_request_buf = {}    # : Dict[str, CancelRequest] # local_orderid: req

        # Hook cancel order function
        self._cancel_order = gateway.cancel_order # : Callable[CancelRequest]
